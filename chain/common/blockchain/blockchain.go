...
import (
	...
	"github.com/aiot-network/aiotchain/chain/db/chain_db"
	...
	servicesync "github.com/aiot-network/aiotchain/service/sync"
...
func (c *Chain) checkMsg(msg types.IMessage) error {
	...
	if err := c.status.CheckBlockMsg(msg, true); err != nil {
		return err
	}
	return nil
}
